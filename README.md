...
- __Anchor__ (:old_key: _keyword_) [_Skulls & Sails_]
...
- __Crew__ (:gem: _resource_) [_Skulls & Sails_]
...
- __Day__ (:old_key: _keyword_) [_War of Shadows_]
...
- __Dreambind__ (:old_key: _keyword_) [_Dreamscape_]
...
- __Dreamborn__ (:black_flag: _faction_) [_Dreamscape_]
...
- __Echo__ (:old_key: _keyword_) [_Valley of the Ancients_]
...
- __Empowered__ (:old_key: _keyword_) [_Gift of the Elements_]
...
- __Energize__ (:old_key: _keyword_) [_Rise of Vigil, Darkness Unleashed_]
...
- __Energy__ (:gem: _resource_) [_Rise of Vigil, Darkness Unleashed_]
...
- __Event__ [_Storm of Souls, Gift of the Elements_]
...
- __Event__ (:black_joker: _card_) [_Storm of Souls, Gift of the Elements_]
  - A special type of card which is in play when an Event is active. The Event card describes the event.
- __Event Trophy__ (:old_key: _keyword_) [_Storm of Souls_]
...
- __Fate__ (:old_key: _keyword_) [_Delirium_]
  - Fate effects take place when a card enters the center row.
- __Fate Auction__ (:old_key: _keyword_) [_Delirium_]
...
- __Infest__ (:old_key: _keyword_) [_Gift of the Elements_]
...
- __Insight__ (:gem: _resource_) [_Delirium, Deliverance, Dreamscape_]
...
- __Immortal Heroes__ (:heavy_plus_sign: _expansion_)
  ...
  - Soul Gems
  - Ongoing Trophy
- __Keystones__ (:gem: _resource_) [_Valley of the Ancients_]
...
- __Multi-Unite__ (:old_key: _keyword_) [_Realms Unraveled_]
...
- __Multifaction__ (:black_joker: _card_) [_Realms Unraveled, Dawn of Champions_]
...
- __Phantasm__ (:old_key: _keyword_) [_Deliverance_]
...
- __Portal__ (:black_joker: _card_) [_Promo Pack 5_]
...
- __Raid__ (:old_key: _keyword_) [_Skulls & Sails_]
...
- __Rally__ (:old_key: _keyword_) [_Dawn of Champions_]
...
- __Realms Unraveled__ (:heavy_plus_sign: _expansion_)
  ...
  - Transform Cards
  - Multi-Unite
- __Recur__ (:old_key: _keyword_) [_Delirium_]
...
- __Reputation__ (:gem: _resource_) [_Dawn of Champions_]
...
- __Serenity__ (:old_key: _keyword_) [_Valley of the Ancients_]
...
- __Thukal, The Kraken__ (:zombie: _monster_) [_Skulls & Sails_]
...
- __Transform__ (:old_key: _keyword_) [_Darkness Unleashed, Deliverance, Gift of the Elements, Realms Unraveled_]
...
- __Transforming Event__ [_Gift of the Elements_]
...
- __Treasure__ (:black_joker: _card_) [_Darkness Unleashed, Rise of Vigil, Skulls & Sails_]
...
- __Trophy__ (:old_key: _keyword_) [_Immortal Heroes, Storm of Souls_]
...
- __Valley of the Ancients__ (:heavy_plus_sign: _expansion_)
  ...
  - Serenity
  - Center Row Effects
- __Vision__ (:black_joker: _card_) [_Dreamscape_]
