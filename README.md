...
- __Event Trophy__ (_keyword_) [_Storm of Souls_]
...
- __Fate__ (_keyword_) [_Delirium_]
  - Fate effects take place when a card enters the center row.
- __Fate Auction__ (_keyword_) [_Delirium_]
...
- __Infest__ (_keyword_) [_Gift of the Elements_]
...
- __Multi-Unite__ (_keyword_) [_Realms Unraveled_]
...
- __Night__ (_keyword_) [_War of Shadows_]
  - Gain the Night effect if it is currently Night.
- __Ongoing__ (_keyword_) [_Dreamscape, Immortal Heroes_]
...
- __Phantasm__ (_keyword_) [_Deliverance_]
...
- __Raid__ (_keyword_) [_Skulls & Sails_]
...
- __Rally__ (_keyword_) [_Dawn of Champions_]
...
- __Realms Unraveled__ (_expansion_)
  ...
  - Transform Cards
  - Multi-Unite
- __Recur__ (_keyword_) [_Delirium_]
...
- __Serenity__ (_keyword_) [_Valley of the Ancients_]
...
- __Transform__ (_keyword_) [_Darkness Unleashed, Deliverance, Gift of the Elements, Realms Unraveled_]
...
- __Trophy__ (_keyword_) [_Immortal Heroes, Storm of Souls_]
